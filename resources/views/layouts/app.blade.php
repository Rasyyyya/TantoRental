...
<head>
    ...
    <link rel="stylesheet" href="tailwind.css"
        ...
        src="https://kit.fontawesome.com/43805eeee9.js" crossorigin="anonymous" referrerpolicy="no-referrer" />
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="bg-violet-500 rounded-2xl p-12 text-center -mt-64 mb-24">
                ...
                <p class="text-xl mb-12 max-w-3xl mx-auto">
                    Butuh bantuan atau siap memesan kendaraan Anda? Hubungi kami sekarang untuk layanan cepat dan
                    pemesanan mudah!
                </p>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex gap-4">
                    <a href="/"
                        class="w-12 h-12 border-2 border-white rounded-full flex items-center justify-center hover:bg-violet-500 transition-colors duration-200">
